package com.snackbar.payment.application.usecases.impl;
...
public class CreatePaymentUseCaseImpl implements CreatePaymentUseCase {
    ...
    public CreatePaymentUseCaseImpl(PaymentGateway paymentGateway, OrderService orderService) {
    ...
    public Payment createPayment(Payment payment) {
        ...
        Payment createdPayment = paymentGateway.createPayment(payment);
